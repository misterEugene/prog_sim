...
(Это сочетание встречается в тексте урока несколько раз, поэтому нажимай **Enter** до
тех пор, пока подсветка не перепрыгнет с текста задания на нужную строку в коде.)
