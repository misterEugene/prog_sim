...
обработчика, сразу под строкой \`msg.textContent = "Готово! Теперь войди…";\`. Нажми
**Delete** и вставь новую
...
блок выделится синим. Нажми **Delete** и замени на:
...
Если дописать \`#welcome=…\` к адресу самой платформы (\`index2.html\`, где три колонки) -
