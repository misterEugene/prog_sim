...
впиши в каждую свой пункт. Каждый пункт стоит между \`>\` и \`</a>\`,
а нужную ссылку узнаёшь по адресу \`href\`. Заполни **по порядку**:
- строка \`<a href="#home">[ВПИШИ ПУНКТ МЕНЮ]</a>\` → впиши **Главная**
- строка \`<a href="#products">[ВПИШИ ПУНКТ МЕНЮ]</a>\` → впиши **Товары**
- строка \`<a href="#contacts">[ВПИШИ ПУНКТ МЕНЮ]</a>\` → впиши **Контакты**
