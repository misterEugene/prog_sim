...
// (см. ниже). Подключается ТОЛЬКО в урок_1.html.
// ============================================================
...
const STEP_FILL = {
  ...
  "Страницы «Вход» и «Регистрация»": {
    ...
    emmetHtml: FILL_LOGIN_H2,
  },
  "Навигация по страницам (JS-роутер)": {
    answers: {
      "[ВПИШИ ПРИВЕТСТВИЕ]": "С возвращением",
      "[ВПИШИ ЗНАЧОК ПОЛЬЗОВАТЕЛЯ]": "👤",
      "[ВПИШИ ТЕКСТ ВЫХОДА]": "Выйти",
      "[ВПИШИ ТЕКСТ ВХОДА]": "Войти",
    },
  },
  "Аккаунты: регистрация и вход ⚠": {
    answers: {
      "[ВПИШИ СООБЩЕНИЕ О ПУСТЫХ ПОЛЯХ]": "Заполни логин и пароль",
      "[ВПИШИ СООБЩЕНИЕ О РАЗНЫХ ПАРОЛЯХ]": "Пароли не совпадают",
      "[ВПИШИ СООБЩЕНИЕ О ЗАНЯТОМ ЛОГИНЕ]": "Такой логин уже занят",
      "[ВПИШИ СООБЩЕНИЕ ОБ УСПЕШНОЙ РЕГИСТРАЦИИ]": "Готово! Теперь войди на странице «Вход».",
      "[ВПИШИ ПРИВЕТ]": "Привет",
      "[ВПИШИ СООБЩЕНИЕ ОБ ОШИБКЕ ВХОДА]": "Неверный логин или пароль",
    },
  },
  "Страница товара и комментарии ⚠": {
    answers: {
      ...
      "[ВПИШИ ЦВЕТ]": "#5b3df5",
      "[ВПИШИ ТЕКСТ ССЫЛКИ НАЗАД]": "Назад в каталог",
      "[ВПИШИ ПОДСКАЗКУ В ПОЛЕ]": "Ваш комментарий…",
      "[ВПИШИ ТЕКСТ КНОПКИ ОТПРАВКИ]": "Отправить",
      "[ВПИШИ ПРИГЛАШЕНИЕ ВОЙТИ]": "Чтобы оставить комментарий",
      "[ВПИШИ ОПИСАНИЕ СМАРТФОНА]": "Мощный смартфон с большим экраном и хорошей камерой.",
      "[ВПИШИ ОПИСАНИЕ НАУШНИКОВ]": "Беспроводные наушники с чистым звуком.",
      "[ВПИШИ ОПИСАНИЕ ГЕЙМПАДА]": "Удобный геймпад для любимых игр.",
    },
  },
  "Телефоны: бургер-меню с анимацией 📱": {
    answers: {
      "[ВПИШИ ЦВЕТ ПОЛОСОК]": "#fff",
      "[ВПИШИ РАЗМЕР ЗАГОЛОВКА]": "28px",
    },
  },
  "Телефоны: товары и формы 📱": {
    answers: {
      "[ВПИШИ ОТСТУП]": "16px",
    },
  },
...
//     урок_1.html#mega-admin        (или  урок_1.html?mega-admin)
