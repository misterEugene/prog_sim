...
@media (max-width: 600px) {
	...
	.banner h1 { font-size: 28px; }
      ...
      taskMd: `**1.** Нажми «Вставить CSS» ⬇ → ▶ Запустить.

[[btn:css]]

**2. Проверь адаптивность:** возьми правый край окна просмотра (или всего браузера)
...
**2.** Снова сузь окно. Теперь на узком экране карточки товаров и отзывы идут
**в один столбик** друг под другом (так удобнее листать пальцем), а формы входа и
страница товара занимают всю ширину. Поздравляем — твой магазин стал
**адаптивным** и красиво выглядит и на компьютере, и на телефоне! 🎉📱`,
      hintMd:
