...
**2. Название (index.html).** Замени \`[ВПИШИ НАЗВАНИЕ МАГАЗИНА]\` на: **МегаМагазин**
...
**5. Цвет шапки.** Замени \`[ВПИШИ ЦВЕТ]\` на: **#5b3df5** → ▶ Запустить.

**6. Размер логотипа.** Замени \`[ВПИШИ РАЗМЕР]\` на: **24px** → ▶ Запустить.
