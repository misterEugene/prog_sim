...
**6.** Замени \`[ВПИШИ СЛОВО]\` на: **Корзина** (значок 🛒, двоеточие \`:\` и цифру
\`0\` не трогай) → нажми ▶ Запустить и посмотри.
...
**7. Цвет шапки.** Замени \`[ВПИШИ ЦВЕТ]\` на: **#5b3df5** → ▶ Запустить.

**8. Размер логотипа.** Замени \`[ВПИШИ РАЗМЕР]\` на: **24px** → ▶ Запустить.
