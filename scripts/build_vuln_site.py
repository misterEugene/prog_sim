...
STEP_FILL = {
  ...
  "Телефоны: бургер-меню с анимацией 📱": {"answers": {
      "[ВПИШИ ЦВЕТ ПОЛОСОК]": "#fff",
      "[ВПИШИ РАЗМЕР ЗАГОЛОВКА]": "28px",
  }},
  "Телефоны: товары и формы 📱": {"answers": {
      "[ВПИШИ ОТСТУП]": "16px",
  }},
}
