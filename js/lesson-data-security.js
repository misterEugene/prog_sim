...
🔗 **Хочешь как по-настоящему?** Нажми **🔗 Открыть в новой вкладке**, и в **адресной
строке** этой вкладки в самый конец допиши \`#welcome=<img src=x onerror=alert('Взлом!')>\`
и нажми **Enter**. Это и есть та самая вредная ссылка, по которой «щёлкнула бы жертва»
- окошко выскочит снова.
