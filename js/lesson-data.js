...
**3.** Добавим под заголовком новый абзац. Делай по порядку:

**3.1. Сделай пустую строку.** Поставь курсор сразу **после закрывающего тега**
\`</h1>\` (в самом конце этой строки) и нажми **Enter** — ниже появится новая
пустая строка.

**3.2. Напечатай на этой строке абзац:**
...
**3.3. Нажми ▶ Запустить.** Под заголовком появился твой абзац!`,
      hintMd:
