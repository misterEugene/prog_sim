...
версию (она и пароль хэширует, и заодно не пускает слишком короткие пароли):
...
\`solnyshko12\` по-прежнему получается. И короткий пароль (3 буквы) сайт всё так же не
пускает. 🛡️`,
