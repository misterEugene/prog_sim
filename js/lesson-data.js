...
**3.** Теперь добавим абзац под заголовком. Сначала сделай для него **новую
пустую строку**: поставь курсор сразу **после закрывающего тега** \`</h1>\`
(в самом конце этой строки) и нажми **Enter** — появится пустая строка ниже.
...
На этой новой пустой строке напечатай:
